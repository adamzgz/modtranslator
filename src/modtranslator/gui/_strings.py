...
_UI_STRINGS: dict[str, dict[str, str]] = {
    "EN": {
        ...
        "dl_start": "Downloading {n} required model(s) (may take several minutes)...",
        "dl_progress": "[{i}/{n}] Downloading {name}...",
        "dl_progress_short": "Downloading {name}...",
        "dl_error": "  Error downloading {name}: {err}",
        "dl_done": "  {name} ready.",
        "dl_all_done": "Models downloaded. Loading translation engine...",
        "dl_error_dialog": "Could not download model:\n{name}\n\nCheck your internet connection.",
    },
    "ES": {
        ...
        "dl_start": "Descargando {n} modelo(s) necesarios (puede tardar varios minutos)...",
        "dl_progress": "[{i}/{n}] Descargando {name}...",
        "dl_progress_short": "Descargando {name}...",
    ...
    "FR": {
        ...
        "dl_start": "Téléchargement de {n} modèle(s) requis (peut prendre plusieurs minutes)...",
        "dl_progress": "[{i}/{n}] Téléchargement de {name}...",
        "dl_progress_short": "Téléchargement de {name}...",
    ...
    "IT": {
        ...
        "dl_start": "Download di {n} modello/i necessario/i (può richiedere diversi minuti)...",
        "dl_progress": "[{i}/{n}] Download di {name}...",
        "dl_progress_short": "Download di {name}...",
    ...
    "PT": {
        ...
        "dl_start": "Baixando {n} modelo(s) necessário(s) (pode levar vários minutos)...",
        "dl_progress": "[{i}/{n}] Baixando {name}...",
        "dl_progress_short": "Baixando {name}...",
    ...
    "RU": {
        ...
        "dl_start": "Загрузка {n} необходимых моделей (может занять несколько минут)...",
        "dl_progress": "[{i}/{n}] Загрузка {name}...",
        "dl_progress_short": "Загрузка {name}...",
    ...
    "PL": {
        ...
        "dl_start": "Pobieranie {n} wymaganych modeli (może potrwać kilka minut)...",
        "dl_progress": "[{i}/{n}] Pobieranie {name}...",
        "dl_progress_short": "Pobieranie {name}...",
